package gererDepensePane.InfosGeneralePane;
...
public abstract class formulaireElevePrincipalController extends StackPane implements Initializable {
	...
	public formulaireElevePrincipalController() {

		JfxUtils.setAll("/gererDepensePane/InfosGeneralePane/InfosGeneralePane.fxml", this);
	...
	public void chargerElement(Client personne) {

		txtNomAr.setText(personne.getNomAr());
		txtPrenomAr.setText(personne.getPrenomAr());
		txtNumeroInscription.setText("" + personne.getIdClient());
	...
	public Client setElement(Client personne) {
