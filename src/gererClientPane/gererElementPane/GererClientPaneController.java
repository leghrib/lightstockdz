package gererClientPane.gererElementPane;
...
public abstract class GererClientPaneController extends StackPane implements Initializable {
	@FXML
...
public Client Client = new Client();
	...
	public GererClientPaneController() {

		JfxUtils.setAll("/gererClientPane/gererElementPane/gererClientPane.fxml", this);
		formulaireElevePrincipalController = new formulaireElevePrincipalController() {
			@Override
			public void refresh() {
				GererClientPaneController.this.refresh(getInsc());
			}
		};
